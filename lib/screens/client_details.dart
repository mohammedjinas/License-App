    ...
    return Container(decoration: const BoxDecoration(image: DecorationImage(image: AssetImage("assets/images/login_bg.jpg"),),),
      ...
      body: Column(children: [
              ...
              onPressed: () {
                ...
                Container(alignment: Alignment.center,padding: const EdgeInsets.symmetric(horizontal: 15,vertical: 20),height: height *0.5,width: width,
                child: AutoSizeTextField(controller: resultText,readOnly: true,decoration: const InputDecoration(border: InputBorder.none,),),),
      ],),),);
  }
