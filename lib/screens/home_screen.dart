  ...
  Widget build(BuildContext context)
  {
      ...
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            children: [
              ButtonWidget(buttonText: "QR Code Scan", returnWidget: const ScanScreen()),
              
              ButtonWidget(buttonText: "Client Details", returnWidget: const ClientDetials()),
              
              ButtonWidget(buttonText: "My License", returnWidget: const MyLicense(callingFrom: "Clients",)),
              
              if(userFlag == 1 || userFlag == 3)
              ButtonWidget(buttonText: "My Clients", returnWidget: const MyLicense(callingFrom: "SalesMan")),
